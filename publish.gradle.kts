...
publishing {
  ...
  publications {
    register("mavenJava", MavenPublication::class) {
      ...
      pom {
        name.set("kotest-extensions-gherkin")
        description.set("Kotest extension for Gherkin")
        url.set("http://www.github.com/kotest/kotest-extensions-gherkin")

        scm {
          connection.set("scm:git:http://www.github.com/kotest/kotest-extensions-gherkin")
